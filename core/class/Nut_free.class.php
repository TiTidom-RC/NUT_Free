...
class Nut_free extends eqLogic {
	...
	public static function createCmd($eqLogic = null) {
		$commandsConfig = array(
			...
			'ups_serial'         => array('name' => 'Numéro Série',                                           'subtype' => 'string', 'nutCmd' => 'ups.serial',          'icon' => '<i class="fas fa-barcode"></i>'),
			'ups_status'         => array('name' => 'Code NUT',                                                 'subtype' => 'string', 'nutCmd' => 'ups.status',          'icon' => '<i class="fas fa-code"></i>'),
			'ups_status_label'   => array('name' => 'Statut Onduleur',                                           'subtype' => 'string', 'nutCmd' => 'ups.status',          'icon' => '<i class="fas fa-plug"></i>'),
