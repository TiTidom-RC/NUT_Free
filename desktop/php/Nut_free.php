                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 nut-list-section">
                        <form class="form-horizontal">
                            <fieldset>
                                <legend>
                                    <i class="fas fa-terminal"></i> {{Commandes instcmd}}
                                    ...
                                    <a id="bt_refresh_instcmds" class="btn btn-xs btn-default pull-right"><i class="fas fa-sync"></i> {{Rafraîchir}}</a>
                                </legend>
                            ...
                            <fieldset>
                                <legend>
                                    <i class="fas fa-sliders-h"></i> {{Variables RW}}
                                    ...
                                    <a id="bt_refresh_rwvars" class="btn btn-xs btn-default pull-right"><i class="fas fa-sync"></i> {{Rafraîchir}}</a>
                                </legend>
